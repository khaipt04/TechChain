                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap justify-content-between bottom-content">
                                <div class="form-check">
                                    <input name="remenber" type="checkbox" class="form-check-input width-auto" id="exampleCheck1">
                            ...
                            <p class="outer-link">Don't have an account? <a href="{{route('login')}}">Register here </a>
                            </p>
                        </div>
                    </form>
                </div>
