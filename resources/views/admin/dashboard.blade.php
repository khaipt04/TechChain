          ...
          <div class="card-body">
            ...
            <div class="d-flex text-body-secondary pt-3">
                <div class="p-2 me-2 bg-{{($dh->status == 'success')?'success':(
                    $dh->status == 'cancle'?'danger':'warning'
                )}} text-white">
                ...
                <a href="#" class="py-2 mb-0 small lh-sm border-bottom w-100 text-decoration-none text-body-secondary">
                  <strong class="d-flex justify-content-between">
                    ...
                    <div>
                      ...
                      <span class="badge bg-success-subtle text-success"><i class="far fa-money-bill-wave"></i>{{number_format($dh->total_money)}}</span>
                    </div>
                  </strong>
                  Đặt bởi <i>{{$dh->user_fullname}}</i> lúc {{$dh->created_at->format('H:i d/m/Y')}}
                </a>
            </div>
            @endforeach
          </div>
